"""Intrusion detector — Module 13.

Wraps a YOLO model (``ai/weights/intrusion.pt``) to detect intruders
and unauthorised access in camera frames.  When YOLO or the weight
file is missing the detector gracefully degrades to no-op.
"""
...
class IntrusionDetector(BaseDetector):
    """Intrusion detection backed by a YOLOv8 model."""
