"""Crowd analyser — Module 12.

Wraps a YOLO model (``ai/weights/crowd.pt``) to analyse crowd density
and detect dangerous overcrowding in camera frames.  When YOLO or the
weight file is missing the detector gracefully degrades to no-op.
"""
...
class CrowdDetector(BaseDetector):
    """Crowd density and overcrowding detection backed by YOLOv8."""
